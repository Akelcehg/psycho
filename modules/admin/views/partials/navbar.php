    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-user fa-fw"></i> Психологи<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="<?= Url::base() ?>/admin/directions">Список направлений</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="<?= Url::base() ?>/admin/psychologist-top">Топ психологов</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#"><i class="fa fa-user fa-fw"></i> Форум<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="<?= Url::base() ?>/admin/discussion-categories">Разделы</a>
                        </li>
                    </ul>
                </li>
                <li>
