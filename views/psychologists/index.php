            ...
            <div class="nicdark_textevidence">
                <div
                    ...
                    <div class="nicdark_focus nicdark_width_percentage25">
                        <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey medium subtitle" type="text"
                               placeholder="NAME" value="" size="200">
                    </div>
                    <div class="nicdark_focus nicdark_width_percentage25">
                        <div
                            class="nicdark_marginleft20 nicdark_disable_marginleft_iphoneland nicdark_disable_marginleft_iphonepotr">
                    ...
                    <div class="nicdark_focus nicdark_width_percentage25">
                        <div
                            class="nicdark_marginleft20 nicdark_disable_marginleft_iphoneland nicdark_disable_marginleft_iphonepotr">
                            <input
                                class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey medium subtitle nicdark_calendar hasDatepicker"
                                placeholder="DATE" type="text" value="" id="dp1452612894853">
                        </div>
                    </div>
                    <div class="nicdark_focus nicdark_width_percentage25">
                        <div
                            class="nicdark_marginleft20 nicdark_disable_marginleft_iphoneland nicdark_disable_marginleft_iphonepotr">
                            <input
                                class="nicdark_btn fullwidth nicdark_bg_green medium nicdark_shadow nicdark_radius white"
