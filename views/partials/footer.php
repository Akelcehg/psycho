...
<section class="nicdark_section nicdark_bg_blue_custom">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_3 nomargin percentage">
                ...
                <div class="nicdark_margin10">
                    ...
                    <div class="nicdark_space20"></div>
                    <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor
                        sit
            ...
            <div class="grid grid_3 nomargin percentage">
                ...
                <div class="grid nomargin grid_4 percentage">
                    <div class="nicdark_margin10">
                        <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                             src="<?= Url::base() ?>/img/footer/img1.jpg">
                    </div>
                </div>
                ...
                <div class="grid nomargin grid_4 percentage">
                    <div class="nicdark_margin10">
                        <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                             src="<?= Url::base() ?>/img/footer/img2.jpg">
                    </div>
                </div>
                ...
                <div class="grid nomargin grid_4 percentage">
                    <div class="nicdark_margin10">
                        <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                             src="<?= Url::base() ?>/img/footer/img3.jpg">
                    </div>
                </div>
                ...
                <div class="grid nomargin grid_4 percentage">
                    <div class="nicdark_margin10">
                        <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                             src="<?= Url::base() ?>/img/footer/img4.jpg">
                    </div>
                </div>
                ...
                <div class="grid nomargin grid_4 percentage">
                    <div class="nicdark_margin10">
                        <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                             src="<?= Url::base() ?>/img/footer/img5.jpg">
                    </div>
                </div>
                ...
                <div class="grid nomargin grid_4 percentage">
                    <div class="nicdark_margin10">
                        <img alt="" class="nicdark_radius nicdark_opacity nicdark_focus"
                             src="<?= Url::base() ?>/img/footer/img6.jpg">
                    </div>
                </div>
...
<!--<div class="white_mask_05">
    <div class="nicdark_section nicdark_bg_blue_custom nicdark_copyrightlogo">
