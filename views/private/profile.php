...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_space20"></div>
            <p>ЮНПУ им. К. Д. Ушинского,специалист педагогики, психологии;
        ...
        <div class="grid grid_3">
            ...
            <div class="nicdark_divider left small"><span class="nicdark_bg_blue nicdark_radius"></span></div>
            <div class="nicdark_space20"></div>
            <p>с 2011 года Индивидуальные и семейные консультации.
                Проведение тренингов личностного роста.</p>
        </div>
        <div class="grid grid_3">
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <ul class="nicdark_list border">
                    ...
                    <li class="nicdark_border_grey" style="display: table-cell;width:auto;">
                        ...
                        <div class="nicdark_margin20">
                            <div class="nicdark_activity">
                                <p><i class="icon-right-open-outline"></i>&nbsp;Loremasd.</p>
                            </div>
                        </div>
            ...
            <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow">
                ...
                <ul class="nicdark_list border">
                    ...
                    <li class="nicdark_border_grey" style="display:table-cell;width:auto;">
                        <div class="nicdark_margin20">
                            <div class="nicdark_activity">
                                <p><i class="icon-right-open-outline"></i>&nbsp;Lorem.</p>
                            </div>
                        </div>
                    </li>
                    <li class="nicdark_border_grey" style="display: table-cell;width:auto;">
