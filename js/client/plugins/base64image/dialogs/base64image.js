CKEDITOR.dialog.add("base64imageDialog", function (c) {
    ...
    function n(b) {
        e.getElement().setHtml("");
        if ("base64" == b)l && l.setValue(!1, !0), m && m.setValue(!1, !0); else if ("url" == b)l && l.setValue(!0, !0), m && m.setValue(!1, !0), q && p(q.getValue()); else if (r) {
            l && l.setValue(!1, !0);
            m && m.setValue(!0, !0);
            var f = d.getContentElement("tab-source", "file"), b = null;
            try {
                b = f.getInputElement().$
            } catch (a) {
                b =
    ...
    var d = null, a = null, i = null, h = null, e = null, l = null, q = null, m = null, j = 1, o = !0, r = function () {
        var a = !1, c = null;
        try {
        ...
        children: [{
            ...
            type: "text", id: "url", label: "", onChange: function () {
                n("url")
            }
        }]
    }, {
        type: "hbox", widths: ["70px"], children: [{
            ...
            type: "file", id: "file", label: "", onChange: function () {
                n("file")
            }
        }]
    }, {
        ...
        type: "text", id: "url", label: c.lang.common.url, onChange: function () {
            n("url")
        }
    }, {type: "html", id: "preview", html: (new CKEDITOR.template('<div style="text-align:center;"></div>')).output()}];
    return {
        title: c.lang.common.image, minWidth: 450, minHeight: 180, onLoad: function () {
            ...
            if (a) {
                ...
                "string" == typeof a.getAttribute("alt") && d.setValueOf("tab-properties", "alt", a.getAttribute("alt"));
            ...
            if (!("string" != typeof b || null == b || "" === b)) {
                ...
                e.setAttribute("class", "img-responsive article-list");
                e.setAttribute("alt",
        ...
        }, contents: [{id: "tab-source", label: c.lang.common.generalTab, elements: u},
            {
                ...
                elements: [{type: "text", id: "alt", label: c.lang.base64image.alt}, {
                    type: "hbox",
                    widths: ["15%", "15%", "70%"],
                    children: [{type: "text", width: "45px", id: "width", label: c.lang.common.width}, {
                        type: "text",
                        width: "45px",
                        id: "height",
                        label: c.lang.common.height
                    }, {type: "checkbox", id: "lock", label: c.lang.base64image.lockRatio, style: "margin-top:18px;"}]
                }, {
                    ...
                    }, {type: "text", width: "45px", id: "vmargin", label: c.lang.base64image.vSpace}, {
                        type: "text",
                        width: "45px",
                        id: "hmargin",
                        label: c.lang.base64image.hSpace
                    }, {type: "text", width: "45px", id: "border", label: c.lang.base64image.border}]
                }]
            }]
    }
});